...
class TestBaseClass(unittest.TestCase):
    ...
    def test_output(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f_out:
            ...
            self.assertEqual(f_out.getvalue().strip(), expected_output)
    ...
    def test_base_methods_doc(self):
        """check if docstring exist for all methods"""
        self.assertTrue(Base.__init__.__doc__)
        self.assertTrue(Base.integer_check.__doc__)
        self.assertTrue(Base.integer_check2.__doc__)
    ...
    def test_int_value(self):
        ...
        with self.assertRaises(ValueError):
            self.rt1.integer_check(-20, -20)

    def test_int_type(self):
        """check if correct type error is raised"""
        with self.assertRaises(TypeError):
            self.rt2.integer_check2("str", "str")
    ...
    def test_create(self):
        """check if an instanced create and attr set"""
